...
int main(int argc, char **argv)
{
  ...
  // Ref: https://blog.csdn.net/Barry_123/article/details/111314709
  SLAM.Shutdown();
  SLAM.SaveKeyFrameTrajectoryTUM("ORB_SLAM3-KeyFrameTrajectory.txt");
  SLAM.SaveTrajectoryTUM("ORB_SLAM3-Trajectory.txt");
  return 0;
}
