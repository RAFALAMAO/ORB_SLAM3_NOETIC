...
namespace ORB_SLAM3
{
                                                                                                                                                                                                                              ...
                                                                                                                                                                                                                              mnInitialFrameId(0), mbCreatedMap(false), mnFirstFrameId(0), mpCamera2(nullptr)
    {
        ...
        if (!b_parse_cam || !b_parse_orb || !b_parse_imu)
        {
            ...
            std::cerr << b_parse_cam << ", " << b_parse_orb << ", " << b_parse_imu << std::endl;
            try
            {
                throw -1;
            }
    ...
    void Tracking::PrintTimeStats()
    {
        ...
        std::cout << std::endl
                  << std::endl
                  << std::endl;
        std::cout << "Place Recognition (mean$\\pm$std)" << std::endl
                  << std::endl;
        f << std::endl
        ...
        if (mpLoopClosing->vTimeLoopTotal_ms.size() > 0)
        {
            std::cout << std::endl
                      << std::endl
                      << std::endl;
            std::cout << "Loop Closing (mean$\\pm$std)" << std::endl
                      << std::endl;
            f << std::endl
        ...
        if (mpLoopClosing->vTimeMergeTotal_ms.size() > 0)
        {
            ...
            std::cout << std::endl
                      << std::endl
                      << std::endl;
            std::cout << "Map Merging (mean$\\pm$std)" << std::endl
                      << std::endl;
            f << std::endl
        ...
        if (mpLoopClosing->vTimeGBATotal_ms.size() > 0)
        {
            ...
            std::cout << std::endl
                      << std::endl
                      << std::endl;
            std::cout << "Full GBA (mean$\\pm$std)" << std::endl
                      << std::endl;
            f << std::endl
    ...
    bool Tracking::ParseIMUParamFile(cv::FileStorage &fSettings)
    {
        ...
        std::cout << "Parse IMU parameters: OK" << std::endl;
        return true;
    }
